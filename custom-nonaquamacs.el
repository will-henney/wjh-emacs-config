(custom-set-faces
 ...
 '(org-block-background ((t (:inherit fixed-pitch :background "gray18" :height 0.8))))
 ...
 '(org-table ((t (:inherit fixed-pitch :foreground "PaleTurquoise1" :height 0.7))))
 '(org-todo ((t (:foreground "dark orange" :weight bold))))
 '(outline-1 ((t (:inherit font-lock-function-name-face :weight bold))))
 '(outline-2 ((t (:inherit (font-lock-variable-name-face outline-1)))))
 '(outline-3 ((t (:inherit (font-lock-keyword-face outline-1)))))
 '(outline-4 ((t (:inherit (font-lock-comment-face outline-1)))))
 '(outline-5 ((t (:inherit (font-lock-type-face outline-1)))))
 '(outline-6 ((t (:inherit (font-lock-constant-face outline-1)))))
 '(outline-7 ((t (:inherit (font-lock-builtin-face outline-1)))))
 '(outline-8 ((t (:inherit (font-lock-string-face outline-1)))))
