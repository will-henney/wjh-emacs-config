(custom-set-faces
 ...
 '(copilot-overlay-face ((t (:inherit shadow :foreground "PaleVioletRed3"))))
 ...
 '(highlight-indentation-face ((t (:underline nil))))
 '(hl-line ((t (:inherit highlight :background "#603838"))))
 '(hydra-posframe-face ((t (:background "gray15" :inherit default))))
 ...
 '(ivy-posframe ((t (:background "gray15" :inherit default))))
 '(jupyter-repl-input-prompt ((t (:foreground "green yellow"))))
 '(jupyter-repl-output-prompt ((t (:foreground "light salmon"))))
 '(jupyter-repl-traceback ((t (:background "DarkOrchid4"))))
 ...
 '(org-column-title ((t (:inherit org-level-1 :background "#2B2B2B" :underline t :weight bold))))
 ...
 '(org-table ((t (:inherit (fixed-pitch unspecified) :family "Victor Mono" :foreground "PaleTurquoise1" :height 1.0))))
 ...
 '(sh-escaped-newline ((t (:inherit font-lock-regexp-grouping-backslash))))
 ...
 '(transient-posframe ((t (:background "gray15" :inherit default))))
