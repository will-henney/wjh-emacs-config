(custom-set-faces
 ...
 '(w3m-anchor ((t (:foreground "gray70" :underline t :weight bold))))
 '(w3m-arrived-anchor ((t (:foreground "gray60" :underline t :weight normal))))
