...
** Latex faces
   ...
   :END:
   :PROPERTIES:
   :tangle:   lisp/wjh-latex-faces-theme.el
   :END:
...
** Org faces
   ...
   :END:
   :PROPERTIES:
   :tangle:   lisp/wjh-org-faces-theme.el
   :END:
...
** Redbox cursor
   :PROPERTIES:
   :tangle:   lisp/wjh-redbox-cursor-theme.el
   :END:
...
** Org misc
   ...
   :END:
   :PROPERTIES:
   :tangle:   lisp/wjh-org-misc-theme.el
   :END:
...
** Miscellaneous appearance
   ...
   :END:
   :PROPERTIES:
   :tangle:   lisp/wjh-misc-appearance-theme.el
   :END:
